...
class Prod {
  ...
  String? indRegra;
  String? vItem;
  Prod({this.cProd, this.xProd, this.nCM, this.cFOP, this.uCom, this.qCom, this.vUnCom, this.vProd, this.indRegra, this.vItem});
...
class Card {
  ...
  Card({this.tpIntegra, this.cNPJ, this.tBand});
